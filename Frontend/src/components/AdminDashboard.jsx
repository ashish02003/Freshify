...
//         try {
//             // Fetch statistics
//             const statsResponse = await fetch(`${baseURL}/api/order/admin/statistics`, {
//                 method: 'GET',
//                 credentials: 'include',
//                 headers: {
//                     'Content-Type': 'application/json'
...
//                 const statsData = statsResult.success ? statsResult.data : statsResult;
//                 setStats(prev => ({ ...prev, ...statsData }));
//             }

//             // Fetch recent orders
//             const ordersResponse = await fetch(`${baseURL}/api/order/admin/all-orders?limit=10`, {
//                 method: 'GET',
//                 credentials: 'include',
//                 headers: {
//                     'Content-Type': 'application/json'
...
//                 const ordersData = ordersResult.success ? ordersResult.data : ordersResult;
//                 const ordersArray = Array.isArray(ordersData) ? ordersData : [];
//                 setRecentOrders(ordersArray);
//             }
...
//                         >
//                             <Package className="h-8 w-8 text-blue-600 mb-2" />
//                             <span className="text-sm font-medium text-gray-700">All Customer's Details</span>
//                         </button>
//                         <button 
//                             onClick={() => window.location.href = '/dashboard/product'}
//                             className="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors"
            ...
            <div className="max-w-7xl mx-auto space-y-4 sm:space-y-6">
                ...
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-4 sm:space-y-0">
                    <div>
                        ...
                        <p className="text-gray-600 mt-1 text-sm sm:text-base">Welcome back! Here's your store overview.</p>
                    </div>
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-3">
                        ...
                        <button 
                            onClick={fetchDashboardData}
                            className="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm hover:bg-blue-700 transition-colors flex items-center justify-center space-x-2 w-full sm:w-auto"
                        >
                            <RefreshCw className="h-4 w-4" />
                            <span>Refresh</span>
                        </button>
                        ...
                        <div className="p-4 sm:p-6 border-b border-gray-200">
                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-4 sm:space-y-0">
                                ...
                                <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-3">
                                    ...
                                    <button className="p-2 border border-gray-300 rounded-lg hover:bg-gray-50 flex justify-center">
                                        <Filter className="h-4 w-4 text-gray-500" />
                                    </button>
                                </div>
                            </div>
                            ...
                            <table className="w-full min-w-[800px]">
                                <thead className="bg-gray-50">
                                    <tr>
                                        ...
                                        <th className="px-3 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Payment Type</th>
                                        <th className="px-3 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Delivery Status</th>
                                ...
                                <tbody className="divide-y divide-gray-200">
                                    {recentOrders
                                        ...
                                        <tr key={order._id} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-3 sm:px-6 py-4 whitespace-nowrap text-sm text-green-700">
                                                {formatCurrency(order.totalAmt || order.total || 0)}
                                            </td>
                                            <td className="px-3 sm:px-6 py-4 whitespace-nowrap">
                                                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                                            ...
                                            <td className="px-3 sm:px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-1 sm:space-y-0 sm:space-x-2">
                                                    ...
                                                    <button className="text-blue-600 hover:text-blue-900 flex justify-center">
                                                        <Eye className="h-4 w-4" />
                                                    </button>
                                                </div>
                                            </td>
